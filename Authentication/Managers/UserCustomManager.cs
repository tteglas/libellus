...
namespace Authentication.Managers
{
    ...
    public class UserCustomManager : UserManager<Libellus.DataAccess.Domain.User>
    {
        ...
        public static UserCustomManager Create(IdentityFactoryOptions<UserCustomManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Libellus.DataAccess.Domain.User>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Libellus.DataAccess.Domain.User>
            {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<Libellus.DataAccess.Domain.User>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
